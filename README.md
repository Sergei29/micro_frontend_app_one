...
- [`frontend_one`](https://github.com/Sergei29/micro_frontend_app_one): ( current repo ) exposes `Header` component,
- [`frontend_two`](https://github.com/Sergei29/micro_frontend_app_two): exposes `Footer` component,
